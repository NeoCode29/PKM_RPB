...
import { PenilaianAdministrasiClientForm } from '@/components/reviewer/PenilaianAdministrasiClient';
...
export default async function PenilaianAdministrasiPage({ 
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      <div className="flex items-center gap-4">
        <BackButton href={`/reviewer/penilaian-administrasi/${bidangId}`} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <Suspense fallback={<Skeleton className="h-64 w-full rounded-lg" />}>
              <PenilaianAdministrasiClientForm 
                bidangId={bidangId} 
